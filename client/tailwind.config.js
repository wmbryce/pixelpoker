  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'stack-win': {
          '0%':  { transform: 'scale(1)',   color: '#FFB800' },
          '30%': { transform: 'scale(1.25)', color: '#ffffff', textShadow: '0 0 16px #FFB800' },
          '100%': { transform: 'scale(1)',   color: '#FFB800', textShadow: 'none' },
        },
        'pot-award': {
          '0%':   { opacity: '1', transform: 'scale(1)',   color: '#FFB800' },
          '15%':  { opacity: '1', transform: 'scale(1.2)', color: '#ffffff', textShadow: '0 0 24px #FFB800, 0 0 48px #FFB80080' },
