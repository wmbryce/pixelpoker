...
function QuickPlayScreen({ onJoin, onBack }: Props) {
  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      ...
      <button
        onClick={handleJoin}
        className="w-full bg-vice-gold text-vice-bg py-3 font-bold tracking-widest uppercase text-sm btn-pixel hover:brightness-110"
      >
        FIND TABLE ▶
      </button>
      <button
